...
A sensor rate of 416 Hz is used for both the accelerometer and the gyroscope. The default MISO, MOSI and CLK pins are also used, as this relies on the arduino SPI.h library. Please refer to the example file for more information.
